// src/lib/sitemap-import.test.ts
...
var listPostsQueryPageDefault = 1;
var listPostsQueryLimitDefault = 50;
var listPostsQueryLimitMax = 50;
var ListPostsQueryParams = objectType({
  "category": coerce.string().optional(),
  "search": coerce.string().optional(),
  "page": coerce.number().min(1).default(listPostsQueryPageDefault),
  "limit": coerce.number().min(1).max(listPostsQueryLimitMax).default(listPostsQueryLimitDefault)
});
var ListPostsResponse = objectType({
  "items": arrayType(objectType({
    "id": numberType(),
    "title": stringType(),
    "slug": stringType(),
    "thumbnailUrl": stringType(),
    "sourceImageUrls": arrayType(stringType()),
    "excerpt": stringType(),
    "sourceUrl": stringType().nullish(),
    "category": objectType({
      "id": numberType(),
      "name": stringType(),
      "slug": stringType(),
      "postCount": numberType()
    }),
    ...
    "tmdb": objectType({
      ...
      "voteCount": numberType().nullable(),
      "revenue": numberType().nullable(),
      "budget": numberType().nullable(),
      "posterUrl": stringType().nullable(),
      ...
      "cast": arrayType(objectType({
        "name": stringType(),
        "character": stringType().nullable(),
        "profileUrl": stringType().nullable()
      })),
      "trailerUrl": stringType().nullable(),
      "imdbId": stringType().nullable(),
      "keywords": arrayType(stringType()),
      "related": arrayType(objectType({
        "id": numberType(),
        "mediaType": enumType(["movie", "tv"]),
        "title": stringType(),
        "year": numberType().nullable(),
...
var GetPostParams = objectType({
  "slug": coerce.string()
});
var GetPostResponse = objectType({
  "id": numberType(),
  "title": stringType(),
  "slug": stringType(),
  "thumbnailUrl": stringType(),
...
var GetMediaAssetParams = objectType({
  "assetId": coerce.string()
});
var GetMediaAssetResponse = unknownType();
var ListCategoriesResponseItem = objectType({
  "id": numberType(),
  "name": stringType(),
  "slug": stringType(),
  "postCount": numberType()
...
var AdminLogoutResponse = objectType({
  "success": booleanType()
});
var GetAdminSummaryResponse = objectType({
  "publishedPosts": numberType(),
  "draftPosts": numberType(),
  "categories": numberType(),
  "lastImportAt": coerce.date().nullable()
});
var ListAdminPostsQueryParams = objectType({
  "status": enumType(["published", "draft", "all"]).optional(),
  "search": coerce.string().optional()
});
var listAdminPostsResponseTwoTitleMatchConfidenceMin = 0;
var listAdminPostsResponseTwoTitleMatchConfidenceMax = 100;
var ListAdminPostsResponseItem = objectType({
  "id": numberType(),
  "title": stringType(),
  "slug": stringType(),
  "thumbnailUrl": stringType(),
  ...
  "status": enumType(["published", "draft"]),
  "sourceDomain": stringType(),
  "titleSource": enumType(["auto", "manual"]),
  "sourceTitle": stringType().nullable(),
  "detectedTitle": stringType().nullable(),
  "titleMatchStatus": enumType(["matched", "review", "unmatched", "unavailable"]),
  "titleMatchConfidence": numberType().min(listAdminPostsResponseTwoTitleMatchConfidenceMin).max(listAdminPostsResponseTwoTitleMatchConfidenceMax).nullable(),
  "titleMatchType": unionType([literalType("movie"), literalType("tv"), literalType(null)]).nullable(),
  "titleMatchYear": numberType().nullable(),
  "tmdbId": numberType().nullable(),
  "tmdbMediaType": unionType([literalType("movie"), literalType("tv"), literalType(null)]).nullable(),
  "tmdbEnrichmentStatus": enumType(["pending", "ready", "review", "unmatched", "unavailable", "failed"])
}));
var ListAdminPostsResponse = arrayType(ListAdminPostsResponseItem);
var DeleteAllAdminPostsResponse = objectType({
  "success": booleanType(),
  "deletedCount": numberType()
});
var UpdateAdminPostParams = objectType({
  "id": coerce.number()
});
var UpdateAdminPostBody = objectType({
  "title": stringType().min(1).optional(),
  "status": enumType(["published", "draft"]).optional(),
  "categoryId": numberType().nullish()
});
var updateAdminPostResponseTwoTitleMatchConfidenceMin = 0;
var updateAdminPostResponseTwoTitleMatchConfidenceMax = 100;
var UpdateAdminPostResponse = objectType({
  "id": numberType(),
  "title": stringType(),
  "slug": stringType(),
  "thumbnailUrl": stringType(),
  ...
  "detectedTitle": stringType().nullable(),
  "titleMatchStatus": enumType(["matched", "review", "unmatched", "unavailable"]),
  "titleMatchConfidence": numberType().min(updateAdminPostResponseTwoTitleMatchConfidenceMin).max(updateAdminPostResponseTwoTitleMatchConfidenceMax).nullable(),
  "titleMatchType": unionType([literalType("movie"), literalType("tv"), literalType(null)]).nullable(),
  "titleMatchYear": numberType().nullable(),
  "tmdbId": numberType().nullable(),
  "tmdbMediaType": unionType([literalType("movie"), literalType("tv"), literalType(null)]).nullable(),
...
var enrichAdminTmdbPostsBodyLimitDefault = 10;
var enrichAdminTmdbPostsBodyLimitMax = 25;
var enrichAdminTmdbPostsBodyIncludeReviewedDefault = false;
var EnrichAdminTmdbPostsBody = objectType({
  "limit": numberType().min(1).max(enrichAdminTmdbPostsBodyLimitMax).default(enrichAdminTmdbPostsBodyLimitDefault),
  "includeReviewed": booleanType().default(enrichAdminTmdbPostsBodyIncludeReviewedDefault)
});
var EnrichAdminTmdbPostsResponse = objectType({
  "attempted": numberType(),
  "enriched": numberType(),
  "review": numberType(),
  "unmatched": numberType(),
  "unavailable": numberType(),
  "failed": numberType()
});
var refreshAdminPostSourceImagesBodyLimitDefault = 10;
var refreshAdminPostSourceImagesBodyLimitMax = 25;
var RefreshAdminPostSourceImagesBody = objectType({
  "limit": numberType().min(1).max(refreshAdminPostSourceImagesBodyLimitMax).default(refreshAdminPostSourceImagesBodyLimitDefault)
});
var RefreshAdminPostSourceImagesResponse = objectType({
  "attempted": numberType(),
  "refreshed": numberType(),
  "failed": numberType()
});
var backfillAdminPostMediaBodyLimitDefault = 5;
var backfillAdminPostMediaBodyLimitMax = 10;
var BackfillAdminPostMediaBody = objectType({
  "limit": numberType().min(1).max(backfillAdminPostMediaBodyLimitMax).default(backfillAdminPostMediaBodyLimitDefault)
});
var BackfillAdminPostMediaResponse = objectType({
  "attempted": numberType(),
  "migrated": numberType(),
  "remaining": numberType()
});
var ImportPostsBody = objectType({
  "url": stringType()
});
var importPostsResponseItemsItemTwoTitleMatchConfidenceMin = 0;
var importPostsResponseItemsItemTwoTitleMatchConfidenceMax = 100;
var ImportPostsResponse = objectType({
  ...
  "items": arrayType(objectType({
    ...
    "detectedTitle": stringType().nullable(),
    "titleMatchStatus": enumType(["matched", "review", "unmatched", "unavailable"]),
    "titleMatchConfidence": numberType().min(importPostsResponseItemsItemTwoTitleMatchConfidenceMin).max(importPostsResponseItemsItemTwoTitleMatchConfidenceMax).nullable(),
    "titleMatchType": unionType([literalType("movie"), literalType("tv"), literalType(null)]).nullable(),
    "titleMatchYear": numberType().nullable(),
    "tmdbId": numberType().nullable(),
    "tmdbMediaType": unionType([literalType("movie"), literalType("tv"), literalType(null)]).nullable(),
...
var DiscoverSitemapsBody = objectType({
  "url": stringType()
});
var DiscoverSitemapsResponse = objectType({
  "sourceUrl": stringType(),
  "sitemapUrl": stringType(),
  "sitemaps": arrayType(objectType({
    "id": stringType(),
    "url": stringType(),
    "postCount": numberType()
  }))
});
var ScrapeSitemapBody = objectType({
  "sitemapId": stringType(),
  "sitemapUrl": stringType(),
  "offset": numberType()
});
var ScrapeSitemapResponse = objectType({
  "sitemapUrl": stringType(),
  "offset": numberType(),
  ...
  "skipped": numberType(),
  "failed": numberType(),
  "nextOffset": numberType().nullable()
});
var GetAdminSettingsResponse = objectType({
  "siteName": stringType(),
  "siteDescription": stringType(),
  "analyticsId": stringType().nullable(),
...
var saveAdminTmdbApiKeyBodyApiKeyMax = 256;
var SaveAdminTmdbApiKeyBody = objectType({
  "apiKey": stringType().min(1).max(saveAdminTmdbApiKeyBodyApiKeyMax)
});
var SaveAdminTmdbApiKeyResponse = objectType({
  "configured": booleanType(),
  "maskedKey": stringType().nullable()
});
var DeleteAdminTmdbApiKeyResponse = objectType({
  "success": booleanType()
});
var GetAdminSitemapResponse = objectType({
  "url": stringType(),
  "indexedUrls": numberType(),
  "lastGeneratedAt": coerce.date().nullable()
});
...
var parseExternalUrl = (value) => {
  const url = new URL(value);
  const hostname = url.hostname.toLowerCase().replace(/^\[|\]$/g, "");
  if (!["http:", "https:"].includes(url.protocol) || hostname === "localhost" || hostname.endsWith(".local") || isIP(hostname) > 0 && isUnsafeIpAddress(hostname)) {
...
var createPinnedLookup = (destination) => {
...
var getSitemapId = (url, secret = process.env.SESSION_SECRET ?? "hdhub4u-development-secret") => createHmac("sha256", secret).update(url).digest("base64url");
var isValidSitemapId = (url, id, secret = process.env.SESSION_SECRET ?? "hdhub4u-development-secret") => {
  const expected = Buffer.from(getSitemapId(url, secret));
  const provided = Buffer.from(id);
  return expected.length === provided.length && timingSafeEqual(expected, provided);
};
var extractXmlLocations = (xml, clean = (value) => value.trim()) => [...xml.matchAll(/<(?:[\w.-]+:)?loc\b[^>]*>([\s\S]*?)<\/(?:[\w.-]+:)?loc>/gi)].map((match) => clean(match[1])).filter(Boolean);
var parseSitemapDate = (value, clean) => {
  if (!value) return null;
  const date = new Date(clean(value));
  return Number.isNaN(date.getTime()) ? null : date;
};
var getUniqueSitemapEntries = (xml, baseUrl, clean = (value) => value.trim()) => {
  const urlBlocks = [
    ...xml.matchAll(
...
var getUniqueSitemapUrls = (xml, baseUrl, clean) => getUniqueSitemapEntries(xml, baseUrl, clean).map((entry) => entry.url);
var imageAttributeNames = /* @__PURE__ */ new Set([
  "src",
  "data-src",
  "data-lazy-src",
  "data-original",
...
var presentationImagePattern = /(?:avatar|favicon|gravatar|logo|icon|emoji|placeholder|site-branding|advert|banner|whatsapp|telegram|hosting|dmca)/i;
var getSourceContentMarkup = (html) => {
  const articleBlocks = [
...
var getImageTagAttributes = (tag) => [...tag.matchAll(/([:@\w-]+)\s*=\s*(?:"([^"]*)"|'([^']*)'|([^\s"'=<>`]+))/g)].map((match) => [
  match[1].toLowerCase(),
  match[2] ?? match[3] ?? match[4] ?? ""
]).filter(([name]) => imageAttributeNames.has(name));
var getSrcsetCandidates = (value) => {
  const candidates = value.split(",").map((candidate) => candidate.trim().split(/\s+/, 1)[0]).filter(Boolean);
  return candidates.length > 0 ? [candidates[candidates.length - 1]] : [];
};
var extractSourceImageUrls = (html, sourceUrl, limit = SOURCE_IMAGE_LIMIT) => {
  ...
  for (const match of getSourceContentMarkup(html).matchAll(/<img\b[^>]*>/gi)) {
    ...
    for (const [name, value] of getImageTagAttributes(tag)) {
      const candidates = name === "srcset" || name === "data-srcset" ? getSrcsetCandidates(value) : [value];
...
var validatePublicSourceImageUrls = async (imageUrls, validateDestination = resolvePublicDestination) => {
  ...
  return results.filter((imageUrl) => Boolean(imageUrl));
};
var getNextSitemapOffset = (offset, processed, total) => offset + processed < total ? offset + processed : null;
var persistSitemapCandidates = async (candidates, options) => {
  let imported = 0;
  let skipped = 0;
  const importTimestamp = options.importTimestamp ?? Date.now();
  for (const [candidateIndex, candidate] of candidates.entries()) {
    const sourcePublishedAt = candidate.publishedAt ?? new Date(importTimestamp - (options.offset + candidateIndex) * 1e3);
...
test("pins outbound lookups to the prevalidated destination", async () => {
  ...
  const lookup2 = createPinnedLookup(destination);
  await new Promise((resolve, reject) => {
    lookup2("rebinding.example", { all: true }, (error, addresses) => {
      try {
...
test("uses sitemap lastmod for persistence and falls back for missing dates", async () => {
  ...
  const insert = async (candidate, publishedAt) => {
  ...
  const sourceDate = /* @__PURE__ */ new Date("2026-08-26T18:58:56.000Z");
...
test("concurrent batches count one insert for each source URL", async () => {
  const storedUrls = /* @__PURE__ */ new Set();
  const candidate = {
